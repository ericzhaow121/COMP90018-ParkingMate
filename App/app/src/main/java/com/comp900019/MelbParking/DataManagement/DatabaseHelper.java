...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table "+TABLE_NAME+" (Bay_id INTEGER PRIMARY KEY, St_marker_id TEXT, Status TEXT, Latitude REAL, Longtitude REAL)");
    }
    ...
    public boolean insert(int bay_id, String st_marker_id, String status, double lat, double lon){
        ...
        cv.put(col_lat, lat);
        Log.d("WRITING LAT", Double.toString(lat));
        cv.put(col_lon, lon);
